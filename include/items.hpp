...
std::vector<std::string>* ENHANCEMENTS_GET() {
    return &ENHANCEMENTS;
}
...
std::vector<std::string>* CARDS_GET() {
    return &CARDS;
}
...
std::vector<std::string>* SUITS_GET() {
    return &SUITS;
}
...
std::vector<std::string>* RANKS_GET() {
    return &RANKS;
}
...
std::vector<std::string>* TAROTS_GET() {
    return &TAROTS;
}
...
std::vector<std::string>* PLANETS_GET() {
    return &PLANETS;
}
...
std::vector<std::string>* COMMON_JOKERS_GET() {
    return &COMMON_JOKERS;
}
...
std::vector<std::string>* UNCOMMON_JOKERS_GET() {
    return &UNCOMMON_JOKERS;
}
...
std::vector<std::string>* RARE_JOKERS_GET() {
    return &RARE_JOKERS;
}
...
std::vector<std::string>* LEGENDARY_JOKERS_GET() {
...
std::vector<std::string>* VOUCHERS_GET() {
    return &VOUCHERS;
}
...
std::vector<std::string>* SPECTRALS_GET() {
    return &SPECTRALS;
}
...
std::vector<std::string>* TAGS_GET() {
    return &TAGS;
}
...
std::vector<std::string>* BOSSES_GET() {
    return &BOSSES;
}